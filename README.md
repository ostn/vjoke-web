...
基于koa2+mysql+vue2.0+ElementXXX管理系统
...
- 然后打开文件`config/index.js`修改`target: 'http://127.0.0.1:3001'`为你自己的服务器地址，默认为`target: 'http://localhost:3001',`。

- 然后打开文件`server/common.js`修改`web_domain: 'http://127.0.0.1:3001'`为你自己的服务器地址，默认为`web_domain: 'http://localhost:3001',`。
